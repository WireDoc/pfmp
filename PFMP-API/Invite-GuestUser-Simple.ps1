# Invite Guest User to Azure AD Tenant - Simple Version
param(
...
try {
    ...
    $invitationParams = @{
        ...
        InvitedUserMessageInfo = @{
            CustomizedMessageBody = "You have been invited to access the PFMP application. Please accept this invitation to sign in with your Microsoft account."
        }
    }
