...
const stepMeta: Partial<Record<OnboardingStepId, StepMeta>> = {
  household: {
    ...
    // Converted to autosave form – enable indicator integration
    autoSave: true,
  },
  'risk-goals': {
  ...
  equity: {
    ...
    // We'll add lightweight autosave semantics for preference tracking.
    autoSave: true,
  },
  review: {
    kind: 'review',
    ...
    // Review will expose finalize action state changes; add autosave indicator semantics.
    autoSave: true,
  },
};
